            ...
            <div className='grid grid-cols-1 sm:grid-cols-12 justify-items-center md:justify-items-stretch items-center'>
                <div className='col-span-8 text-center sm:text-left'>
                    <h1 className='text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold'>
                        <span className='text-transparent block bg-clip-text bg-gradient-to-r from-purple-400 to-red-800'>Привет! Я {'\n'}</span>
                        <TypeAnimation
                            sequence={[
                                'Войнович Денис',
                                2000,
                    ...
                    <div>
                        <button className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-red-800 hover:bg-slate-200 text-white'>Написать мне
                        </button>
                        <button
